...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("║  PASO 2: DEPENDENCY INVERSION DE DEPENDENCIASS  ║");
        ...
        var smsService = new TwilioSmsService();//NUEVO

        // Crear el servicio de citas

        AppointmentService appointmentService = new AppointmentService(repository,
           emailService, smsService);//NUEVO

        // Agendar la cita
        //appointmentService.Schedule(appointment, patientEmail);//MODIFICADO
        appointmentService.Schedule(appointment, patientEmail, patient);//NUEVO
